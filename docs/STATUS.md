...
- Selected release: `data/releases/CURRENT` → `2026.08.07.8` (web mounts via `scripts/sync-web-release.sh`; includes display-only NunaGIS `placenames.geojson`; isolation / single-dependency / seasonal-loss / freight-gap / emergency-gap reports; SQLite FTS5 `place_names_fts`)
